  ...
  <div class="login-box-body">
    ...
    <form action="<?=base_url('/Login/login/')?>" method="POST">
      ...
      <div class="row">
        <!-- /.col -->
        <div class="col-xs-6">
          <a href="<?=site_url('/Register/')?>" class="btn btn-primary btn-block btn-flat pull-right">Register</a>
        </div>
        <div class="col-xs-6">
          <button type="submit" class="btn btn-success btn-block btn-flat pull-right">Login</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
